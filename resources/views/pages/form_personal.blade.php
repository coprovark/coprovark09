...
@section('content')
 ...
 <h1 class="page-header">บันทึกข้อมูล</h1>
                    ...
                    <div class="col-sm-12">
                          <form action="/form_personal_save" method="post" >
                          ...
                          <div class="form-group">
                                ...
                                <div class="form-inline" style="width:100%">
                                     ...
                                     <input type="text" class="form-control" name="FULLNAME" style="width:55%">   
                                   </div>  
                           </div> <br>
                           <div class="form-group">
                  ...
                  <center>
                        ...
                        <a type="button" href="/form_personal" class="btn btn-danger">ยกเลิก</a>                      
                </center>
                        <br> <br> <br>
