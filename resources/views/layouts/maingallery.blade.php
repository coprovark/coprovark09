    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Gallery-images</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/logingallery"><i class="glyphicon glyphicon-user"></i> Login : เข้าสู่ระบบ</a>
                        </li>
                        <li>
                            <a href="/gallery"><i class="fa fa-file"></i> Gallery : หมวดหมู่</a>
                        </li>
                        <li>
                            <a href="/images"><i class="fa fa-bars"></i> images : รูปภาพ</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
